...
import com.mdem.costms.security.TokenAuthenticationFilter;
import com.mdem.costms.security.TokenAuthenticationManager;
import com.mdem.costms.security.AuthenticationAccessDeniedHandler;
...
@Configuration
@EnableWebSecurity
@ComponentScan(basePackages = "com.mdem.costms")
